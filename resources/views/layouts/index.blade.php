...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Bengkel Expert | Manajemen Inventaris</title>
		...
		<meta property="og:site_name" content="Bengkel Expert" />
		<link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
		<link rel="shortcut icon" href="{{asset ('assets/media/logos/logo-putih.png') }}')}}" />
		<!--begin::Fonts-->
...
') }}-->
                                        ...
                                        @php
                                            $user = Auth::user();
                                            $jenisKaryawan = $user->jenisKaryawan;
                                        @endphp
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											<!--begin::Menu wrapper-->
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="{{ asset('storage/' . Auth::user()->foto_karyawan) }}" alt="user" />
											</div>
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<!--begin::Username-->
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::user()->nama_karyawan }}
															<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ $jenisKaryawan->jenis_karyawan ?? 'Tidak Ditemukan' }}</span></div>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">BengkelExpert</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
